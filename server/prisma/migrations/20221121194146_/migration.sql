...
-- AddForeignKey
ALTER TABLE `TA_EtudiantGroupe` ADD CONSTRAINT `TA_EtudiantGroupe_no_etudiant_fkey` FOREIGN KEY (`no_etudiant`) REFERENCES `Etudiant`(`no_etudiant`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `TA_EtuStatut` ADD CONSTRAINT `TA_EtuStatut_no_etudiant_fkey` FOREIGN KEY (`no_etudiant`) REFERENCES `Etudiant`(`no_etudiant`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `FormulaireMath` ADD CONSTRAINT `FormulaireMath_no_etudiant_fkey` FOREIGN KEY (`no_etudiant`) REFERENCES `Etudiant`(`no_etudiant`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `TA_EtudiantPaysStatut` ADD CONSTRAINT `TA_EtudiantPaysStatut_no_etudiant_fkey` FOREIGN KEY (`no_etudiant`) REFERENCES `Etudiant`(`no_etudiant`) ON DELETE RESTRICT ON UPDATE CASCADE;
